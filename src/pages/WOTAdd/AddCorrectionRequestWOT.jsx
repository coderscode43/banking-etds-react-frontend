...
const AddCorrectionRequestWOT = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // /homeWOT/100000/2023-24/add/addCorrectionRequest
      showSuccess(
        response?.data?.successMsg,
        `/homeWOT/${branchCode}/${fy}/list/correctionRequest`
      );
    } catch (error) {
                    ...
                    <div className="w-full">
                      <div className="flex w-full items-center">
                        ...
                        <select
                          ...
                          disabled
                          className="custom-scrollbar h-[38px] w-2/3 rounded-md border border-gray-300 bg-gray-100 px-3 py-1.5 text-sm/6 text-gray-900 focus:outline-none"
                        >
...
export default AddCorrectionRequestWOT;
