            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <DialogPanel className="relative w-full max-w-sm transform overflow-hidden rounded-md bg-white text-left align-middle shadow-xl transition-all">
                  <div className="bg-[#eaf0f9] px-[24px] py-[9px]">
                    <DialogTitle
                      as="h1"
                      className="text-center text-[22px] font-medium text-red-500"
                    >
                      <img
                        className="errorImage absolute top-[14px] left-[45px] h-6"
...
export default MISGenerateReportModal;
