...
import { panRegex, zipDownload } from "@/lib/utils";
import { useContext, useState } from "react";
import ErrorMessage from "./ErrorMessage";

const DownloadCertificateMultiplePan = () => {
  const page = "downloadMultiple";
  ...
  const validate = (data) => {
    ...
    if (data.panNumber && !panRegex.test(data.panNumber)) {
      newErrors.panNumber = "PAN must be in uppercase format (e.g. ABCDE1234F)";
    }
...
export default DownloadCertificateMultiplePan;
